...
=======
>>>>>>> 2c4ec3f5451c26e706977ad726a9a3dfddbd31c6
...
<<<<<<< HEAD
  ...
  # (5) Mouse‐position display (lat/lng follows cursor)
  addMouseCoordinates(
    # position = "topright",           # you can choose "topleft", "bottomleft", etc.
    # labelStyle = "font-size: 12px; background: rgba(255,255,255,0.8); padding: 2px;"
  ) %>%
