...
@fig-Freq50_CA shows the proportion of time each pixel maintained an SPC value above 50%. Most of the southernmost part of the meadow consistently displayed SPC values above 50%, whereas some areas in the northernmost part of the meadow only exceeded this threshold between 50% and 62.5% of the time.
