...
<button onclick="window.open('https://github.com/SigOiry/Coring_Carbon_Seagrasses/raw/refs/heads/main/Data/QGIS/Qgis_Bourgneuf_Bay.zip', '_blank');" 
          style="padding: 10px 20px; background-color: #4CAF50; color: white; border: none; border-radius: 5px; cursor: pointer;"> Download the Qgis project of Bourgneuf Bay </button>
:::
...
leaflet() %>% 
  ...
  addRasterImage(
    ...
    colors  = pal, 
    opacity = 0.8, 
    layerId = "Amount of Years above 50%",
    group = "Amount of Years above 50%"
  ) %>% 
  ...
  addImageQuery(
    ...
    prefix = ""
      ...
      addLayersControl(overlayGroups = "Amount of Years above 50%")
